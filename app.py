...
def main():
    ...
    menu=['Home','view post','search' ,'Login','sign up']
    ...
    if choice=='Home':
        ...
        for i in result:
            ...
            b_article=str(i[2])
            b_date=i[3]
            st.markdown(title_temp.format(b_author,b_title,b_article,b_date),unsafe_allow_html=True)
        ...
        for i in post_result:
            ...
            b_article = i[2]
            b_post_date = i[3]
            st.text("Reading Time:{0:.2f} min".format(reading_time(b_article)))
            st.markdown(title_temp.format(b_title,b_author,b_post_date),unsafe_allow_html=True)
        ...
        if st.sidebar.checkbox('Login') :
            ...
            if result:
                ...
                if task == "Add Posts":
                    ...
                    create_table()
                    blog_author = st.text_input("Write Author Name",max_chars=50)
                    blog_title = st.text_input("Write Post Title",max_chars=50)
                    blog_article= st.text_area('Write Article',height=200)
        ...
        st.header('Sign up for new user')
